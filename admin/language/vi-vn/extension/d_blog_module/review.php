<?php
// Heading
$_['title_title'] = 'Blog đánh giá';

// Text
$_['text_success'] = 'Thành công: Bạn đã sửa đổi các đánh giá!';
$_['text_list'] = 'Danh sách đánh giá';
$_['text_add'] = 'Thêm đánh giá';
$_['text_edit'] = 'Chỉnh sửa đánh giá';
$_['text_default'] = 'Mặc định';
$_['text_blog_module'] = 'Mô-đun blog';
